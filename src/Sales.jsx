          ...
          <tbody>
            {sales.map(s => (
              <tr key={s.id} className="border-t text-center">
                ...
                <td className="p-2">{getProductName(s.productId)}</td>
                <td className="p-2">{dayjs(s.dateSold).format("DD MMM YYYY")}</td>
                <td className="p-2">{s.quantitySold}</td>
                <td className="p-2">KES {s.price}</td>
                <td className="p-2">KES {s.quantitySold * s.price}</td>
              </tr>
            ))}
          </tbody>
        </table>
